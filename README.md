# Ahshok [![Build Status](https://img.shields.io/travis/unindented/ahshok-slim.svg)](http://travis-ci.org/unindented/ahshok-slim) ![Abandoned](https://img.shields.io/badge/status-abandoned-red.svg)
